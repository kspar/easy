...
//
//   npx playwright test course-exercises        (in web/)
...
test('course-exercises', async ({ launch, check }) => {
  const { page, shot, close } = await launch({ role: 'teacher,admin', shotPrefix: 'course-ex-' })
