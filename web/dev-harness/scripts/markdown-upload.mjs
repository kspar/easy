 ...
 *
 * The placeholder logic itself is unit-covered in `dev-harness/unit/markdown-actions.mjs` against
...
const { browser, page, shot } = await launch({ role: 'teacher,admin', shotPrefix: 'md-upload-' })
const check = checker()
