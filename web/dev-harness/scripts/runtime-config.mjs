...
//   cd web/dev-harness && node scripts/runtime-config.mjs
import { launch, checker, BASE_URL } from '../harness.mjs'

const { browser, page, shot } = await launch({ shotPrefix: 'runtime-config-' })
const check = checker()
