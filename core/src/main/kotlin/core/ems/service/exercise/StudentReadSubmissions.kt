...
class StudentReadSubmissionsController {
    ...
    private fun selectStudentSubmissions(courseId: Long, courseExId: Long, studentId: String, limit: Int?, offset: Long?): Resp = transaction {
        ...
        val subQuery = (CourseExercise innerJoin Submission leftJoin AutomaticAssessment leftJoin TeacherAssessment)
            .slice(
                distinctSubmissionId, Submission.solution, Submission.createdAt, Submission.autoGradeStatus,
            ...
            .select {
                ...
                distinctSubmissionId to SortOrder.ASC,
        ...
        val wrapQuery = subTable
            .slice(
                subTable[distinctSubmissionId],
                subTable[Submission.solution],
                subTable[Submission.createdAt],
                subTable[Submission.autoGradeStatus],
                subTable[TeacherAssessment.grade],
                subTable[TeacherAssessment.feedback],
                subTable[autoGradeAlias],
                subTable[autoFeedbackAlias]
            )
            .selectAll()
